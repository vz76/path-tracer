...
public:
	...
	void setL(BBoxNode* bboxNode) {
		left = bboxNode;
	}
	void setR(BBoxNode* bboxNode) {
		right = bboxNode;
	}
	BBoxNode* getL() {
		return left;
...
public:
	...
	void addPathLight(Geometry* light, glm::dvec3 light_color);
	...
	auto& getAllPathLights() { return path_lights; }
...
private:
	...
	std::vector<std::pair<Geometry*, glm::dvec3>> path_lights;
	Camera camera;
...
public:
	...
	std::vector<std::pair<glm::dvec3, glm::dvec3>> randLightPoints();
